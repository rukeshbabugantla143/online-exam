...
<title> Codesankalp || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">codesankalp</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:contact@rudrafusion.in" style="color:#000000">contact@rudrafusion.in</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="https://rudrafusion.in/wp-content/uploads/2025/01/cropped-WhatsApp-Image-2025-01-24-at-11.19.06-AM-1.webp" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a href="http://rudrafusion.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Rudra Fusion</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7569254028 </h4>
		<h4 style="font-family:'typo' ">contact@rudrafusion.in</h4>
		<h4 style="font-family:'typo' ">IT company , Vijayawada</h4></div></div>
		</p>
      </div>
